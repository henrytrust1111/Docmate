  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (profilePicture && data) {
        // Update both profile picture and data
        const formData = new FormData();
        formData.append("profilePicture", profilePicture);
        const responseProfilePicture = await axios.put(
          "https://doc-mate.onrender.com/uploadimage",
          formData,
          { headers }
        );
        console.log(responseProfilePicture.data);
  
        const responseProfileData = await axios.put(Url, data, { headers });
        ...
        // Neither profile picture nor data is provided
        ...
        <div className="PatientProfileUpdate-wrapper">
          ...
          >
            ...
            <div className="PatientProfileUpdate-input-container">
              ...
              <input
                type="text"
                placeholder="Please input allegies"
                className="PatientProfileUpdate-input-input"
                onChange={(e) => setAllegies(e.target.value)}
              />
            </div>
            <div className="PatientProfileUpdate-input-container">
              ...
              <input
                type="text"
                placeholder="Please input your bloodType e.g. A+"
                className="PatientProfileUpdate-input-input"
                onChange={(e) => setBloodType(e.target.value)}
              />
            </div>
