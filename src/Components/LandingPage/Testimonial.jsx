...
import image11 from '../../../public/star.png'
      ...
      <div className="testimonalcarddiv">
        <div className="carrddiv">
          <div className="uppercarrddiv">
            <div className="leftborderdiv"><img src={image} alt="" /> </div>
            <h1>Kayla Schofield</h1>
          </div>

          <div className="midcarrddiv">
            <p>Overall rating</p>
            <div className="middcarrdimg"><img src={image11} alt="" /> </div>
          </div>

          <div className="docmatetextdiv">
            <p>“<span>DocMate</span> has made transitioning on my
              own very easy. I wouldn't be as organized
              as I am without this software so I have
